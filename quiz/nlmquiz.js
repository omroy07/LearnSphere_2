const questions = [
  ...
  },
  {
    ...
    options: [
      'The wall moves',
      'The wall exerts an equal force back on you',
      'No force is applied back',
      'Only you experience the force',
    ],
  ...
  },
  {
    ...
    options: [
      ...
      'The force applied by a moving object',
  ...
  },
  {
    ...
    options: [
      'A car accelerating when force is applied',
      'A book resting on a table',
      'A rocket launching by expelling gases',
      'An object staying at rest',
    ],
...
function showResults() {
  ...
  try {
    if (
      window.quizProgress &&
      typeof window.quizProgress.recordAttemptCanonical === 'function' &&
      window.quizModel &&
      typeof window.quizModel.buildCanonicalAttemptFromLegacyGlobals === 'function'
    ) {
