const questions = [
  {
    question:
      'If the mean of a dataset is 50 and the standard deviation is 5, what is the coefficient of variation?',
    options: ['10%', '5%', '100%', '50%'],
    answer: 0,
  },
  {
  ...
  {
    question:
      "A letter is chosen at random from the word 'STATISTICS'. What is the probability of selecting a vowel?",
    options: ['1/10', '2/10', '3/10', '4/10'],
    answer: 2,
  },
  {
    question:
      'In a normal distribution, approximately what percentage of data lies within one standard deviation from the mean?',
